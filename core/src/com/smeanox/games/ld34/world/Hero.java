...
public class Hero extends Rigidbody implements Updatable, Renderable {
	...
	private void initParticles(){
		bloodInDaFaceSystem = new ParticleSystem(world, "bloodInDaFace", Consts.LAYER_HERO, Textures.get().particle, Color.RED, 0.5f, 5f, 0.5f, 0.005f, 0.001f, 0, 0, 2, 2, -1, 2, 7, 7);
		attackSystem = new ParticleSystem(world, "attack", Consts.LAYER_HERO, Textures.get().particle, new Color(0.5f, 0, 0, 1), 1, 0.4f, 0.1f, 0.5f, 0.05f, 0, 0, 2, 2, -5, 2, 2, 2);
		...
		plantSystem = new ParticleSystem(world, "plant", Consts.LAYER_HERO, Textures.get().particle, new Color(0, 0.8f, 0, 1), 0.8f, 1f, 0.1f, 0.1f, 0.01f, 0, 0, 1, 1, Consts.HERO_VELO * 1.5f, -1, 1, 1);
	}
