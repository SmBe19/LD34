...
public class Hero extends Rigidbody implements Updatable, Renderable {
	...
	private void initParticles() {
		bloodInDaFaceSystem = new ParticleSystem(world, null, Consts.LAYER_PARTICLES, Textures.get().particle, new Color(1, 0, 0, 1), 4f, 5f, 0.5f, 0.0005f, 0.0001f, 0, 0, 2, 2, 20, 100, 277, 277);
		attackedSystem = new ParticleSystem(world, null, Consts.LAYER_PARTICLES, Textures.get().particle, new Color(1, 0, 0, 0.5f), 4f, 5f, 0.5f, 0.01f, 0.005f, 0, 0, 2, 2, 0, 100, 177, 177);
