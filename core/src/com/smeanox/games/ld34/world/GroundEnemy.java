...
public class GroundEnemy extends Enemy {
	...
	private void initParticles(){
		destroySystem = new ParticleSystem(world, null, Consts.LAYER_PLANT, Textures.get().particle, new Color(0.8f, 0.7f, 0.4f, 0.5f), 4f, 1f, 0.2f, 0.001f, 0.0005f, 0, 0, 2, 2, 0, 0, 400, 600);
		bloodSystem = new ParticleSystem(world, null, Consts.LAYER_PLANT, Textures.get().particle, new Color(0.8f, 0.4f, 0.3f, 0.5f), 4f, 1f, 0.2f, 0.001f, 0.0005f, 0, 0, 2, 2, 0, 0, 400, 400);
	}
